      ...
      <div id='nexus_slider_wrapper' class='nexus_slider_wrapper fullwidthbanner-container' >
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="block">
							...
							<div class="padd25 no-padding-top no-padding-bottom padding-left-15"><img src="<?php echo get_template_directory_uri(); ?>/photos/about.jpg" alt="" class="img-responsive"></div>
						</div>
</div>
</div>
</div>
				...
				<div class="row">
						<div class="block1">
							<div class="col-md-3">
								<div class="st-member">
									<div class="st-member-img">
										<img src="<?php echo get_template_directory_uri(); ?>/photos/member1.png" alt="" class="img-responsive">
									</div>
							...
							<div class="col-md-3">
								<div class="st-member">
									<div class="st-member-img">
										<img src="<?php echo get_template_directory_uri(); ?>/photos/member2.png" alt="" class="img-responsive">
									</div>
									<div class="st-member-info">
							...
							<div class="col-md-3">
								<div class="st-member">
									<div class="st-member-img">
										<img src="<?php echo get_template_directory_uri(); ?>/photos/member3.png" alt="" class="img-responsive">
									</div>
									<div class="st-member-info">
							...
							<div class="col-md-3">
								<div class="st-member">
									<div class="st-member-img">
										<img src="<?php echo get_template_directory_uri(); ?>/photos/member4.png" alt="" class="img-responsive">
									</div>
									<div class="st-member-info">
		...
		<section class="features-desc">
			<div class="container">
					...
					<div class="col-md-12 mb55">
						<img src="<?php echo get_template_directory_uri(); ?>/photos/feature.png" alt="" class="img-responsive">
					</div>
								</div>
			</div>
		</section>
					...
					<div class="col-md-12 no-padding ">
						...
						<div class="grid">
							<figure class="portfolio-item" data-groups='["photography"]'>
								<img src="<?php echo get_template_directory_uri(); ?>/photos/portfolio.jpg" alt=""/>
								<figcaption>
							...
							<figure class="portfolio-item" data-groups='["design"]'>
								<img src="<?php echo get_template_directory_uri(); ?>/photos/portfolio2.jpg" alt=""/>
								<figcaption>
									<h2>Nice <span>Lily</span></h2>
									<p>Lily likes to play with crayons and pencils</p>
									<a href="#" class="btn btn-main"> View more</a>								</figcaption>
							...
							<figure class="portfolio-item" data-groups='["photography"]'>
								<img src="<?php echo get_template_directory_uri(); ?>/photos/portfolio3.jpg" alt=""/>
								<figcaption>
									<h2>Nice <span>Lily</span></h2>
									<p>Lily likes to play with crayons and pencils</p>
									<a href="#" class="btn btn-main"> View more</a>								</figcaption>
							...
							<figure class="portfolio-item" data-groups='["design"]'>
								<img src="<?php echo get_template_directory_uri(); ?>/photos/portfolio4.jpg" alt=""/>
								<figcaption>
									<h2>Nice <span>Lily</span></h2>
									<p>Lily likes to play with crayons and pencils</p>
									<a href="#" class="btn btn-main"> View more</a>								</figcaption>
							...
							<figure class="portfolio-item" data-groups='["design"]'>
								<img src="<?php echo get_template_directory_uri(); ?>/photos/portfolio5.jpg" alt=""/>
								<figcaption>
									<h2>Nice <span>Lily</span></h2>
									<p>Lily likes to play with crayons and pencils</p>
									<a href="#" class="btn btn-main"> View more</a>								</figcaption>
							...
							<figure class="portfolio-item" data-groups='["photography"]'>
								<img src="<?php echo get_template_directory_uri(); ?>/photos/portfolio6.jpg" alt=""/>
								<figcaption>
									<h2>Nice <span>Lily</span></h2>
									<p>Lily likes to play with crayons and pencils</p>
									<a href="#" class="btn btn-main"> View more</a>								</figcaption>
							...
							<figure class="portfolio-item" data-groups='["codding"]'>
								<img src="<?php echo get_template_directory_uri(); ?>/photos/portfolio7.jpg" alt=""/>
								<figcaption>
									<h2>Nice <span>Lily</span></h2>
									<p>Lily likes to play with crayons and pencils</p>
									<a href="#" class="btn btn-main"> View more</a>								</figcaption>
							...
							<figure class="portfolio-item" data-groups='["photography"]'>
								<img src="<?php echo get_template_directory_uri(); ?>/photos/portfolio8.jpg" alt=""/>
								<figcaption>
									<h2>Nice <span>Lily</span></h2>
									<p>Lily likes to play with crayons and pencils</p>
									<a href="#" class="btn btn-main"> View more</a>								</figcaption>
							...
							<figure class="portfolio-item" data-groups='["codding"]'>
								<img src="<?php echo get_template_directory_uri(); ?>/photos/portfolio9.jpg" alt=""/>
								<figcaption>
									<h2>Nice <span>Lily</span></h2>
									<p>Lily likes to play with crayons and pencils</p>
									<a href="#" class="btn btn-main"> View more</a>								</figcaption>
							...
							<figure class="portfolio-item" data-groups='["codding"]'>
								<img src="<?php echo get_template_directory_uri(); ?>/photos/portfolio10.jpg" alt=""/>
								<figcaption>
									<h2>Nice <span>Lily</span></h2>
									<p>Lily likes to play with crayons and pencils</p>
									<a href="#" class="btn btn-main"> View more</a>								</figcaption>
							...
							<figure class="portfolio-item" data-groups='["design"]'>
								<img src="<?php echo get_template_directory_uri(); ?>/photos/portfolio11.jpg" alt=""/>
								<figcaption>
									<h2>Nice <span>Lily</span></h2>
									<p>Lily likes to play with crayons and pencils</p>
									<a href="#" class="btn btn-main"> View more</a>								</figcaption>
							...
							<figure class="portfolio-item" data-groups='["design"]'>
								<img src="<?php echo get_template_directory_uri(); ?>/photos/portfolio12.jpg" alt=""/>
								<figcaption>
									<h2>Nice <span>Lily</span></h2>
									<p>Lily likes to play with crayons and pencils</p>
									<a href="#" class="btn btn-main"> View more</a>								</figcaption>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<ul class="clients-carousel">
							<li><img src="<?php echo get_template_directory_uri(); ?>/photos/client.png" class="img-responsive" alt=""></li>
							<li><img src="<?php echo get_template_directory_uri(); ?>/photos/client2.png" class="img-responsive" alt=""></li>
							<li><img src="<?php echo get_template_directory_uri(); ?>/photos/client3.png" class="img-responsive" alt=""></li>
							<li><img src="<?php echo get_template_directory_uri(); ?>/photos/client4.png" class="img-responsive" alt=""></li>
							<li><img src="<?php echo get_template_directory_uri(); ?>/photos/client5.png" class="img-responsive" alt=""></li>
							<li><img src="<?php echo get_template_directory_uri(); ?>/photos/client6.png" class="img-responsive" alt=""></li>
							<li><img src="<?php echo get_template_directory_uri(); ?>/photos/client7.png" class="img-responsive" alt=""></li>
							<li><img src="<?php echo get_template_directory_uri(); ?>/photos/client8.png" class="img-responsive" alt=""></li>
							<li><img src="<?php echo get_template_directory_uri(); ?>/photos/client9.png" class="img-responsive" alt=""></li>
						</ul>
					</div>
				</div>
			</div>
			...
			<div class="container">
				...
				<div class="block">
					<div class="col-md-8">
						<div class="blog-post">
							<div class="post-meta">
								<span class="author"><a href="#"><img src="<?php echo get_template_directory_uri(); ?>/photos/author.jpg" alt=""> John Doe</a></span>,
							...
							<div class="post-thumb"><a href="#"><img src="<?php echo get_template_directory_uri(); ?>/photos/post-thumb.jpg" alt="" class="img-responsive"></a></div>
								...
								<ul>
									<li>
										<div class="recent-post clearfix">
											<a href="#" class="post-thumb"><img src="<?php echo get_template_directory_uri(); ?>/photos/post-thumb-sm.jpg" alt="blog post"></a>
											<h2 class="post-title">
		...
		<section class="contact" id="contact">
			<div class="container">
				...
				<div class="block">
					...
					<div class="col-md-6">
					<div class="mb20">
					<iframe width="500" height="400" frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/place?q=Shopify, Ottawa 150 Elgin Street, 8th Floor Ottawa, ON, Canada&key=AIzaSyAVk-o-EKPBOgtHwdNY1zJvcqKWM-g1drI"></iframe>
					</div>
		...
		<footer class="site-footer">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						&copy; <a href="#">ThemesGround</a> 2015.
        ...
        jQuery(document).ready(function(){
            jQuery('#nexus-rev-slider').show().revolution({
                dottedOverlay: 'none',
                delay: 5000,
                startwidth: 0,
                startheight:500,
